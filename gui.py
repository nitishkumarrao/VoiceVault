...
def voiceverificationlogin():
        ...
        l2=Label(loginwindow,text="Phrase  :",bg="white",font = ('Arial',13,'bold'), fg="#2a72af")
        l2.place(x=100,y=280)
        e1 = Entry(loginwindow, textvariable=m, bg="#e6f2ff",width = 17,font = ('Arial',13,'bold'), fg="#2a72af")
        e1.place(x=200, y=250)
        e2 = Entry(loginwindow, textvariable=NAME, bg="#e6f2ff",width = 35,font = ('Arial',13,'bold'), fg="#2a72af")
...
def home(username):
    ...
    def upload_file(fileurl):
        ...
        if (file_ext == "jpg" or file_ext == "png" or file_ext == "jpeg"):
            copyfile(filename, "C:/Users/nitis/Desktop" + filename)
    ...
    def getImageFile(filename):
        ...
        copyfile("C:/Users/nitis/Desktop" + filename, D_path + filename)
